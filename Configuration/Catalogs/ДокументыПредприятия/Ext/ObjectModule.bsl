...
// 
	// Локализация
	ДокументОтправленНаРаспознавание = РаспознаваниеДокументов.ДокументНаРаспознавании(ЭтотОбъект);
	// Конец Локализация
	...
	Если 
		// Локализация
		ДокументОтправленНаРаспознавание = Ложь И
		// Конец Локализация
		(ЭтоНовый()
	...
	// Локализация
	Если ДокументОтправленНаРаспознавание = Ложь Тогда
	// Конец Локализация

...
Процедура ОтметитьОкончаниеНастройкиУзла(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат.Статус = "Выполнено" Тогда
		ЗавершитьИнициализациюУзла();
		
		Если Не КОДКлиент.УзелИспользуетСобственноеФайловоеХранилище() Тогда
			ЗавершитьНастройкуЗакрытьФорму();
		Иначе
			ВыполнитьНастройкуТомовХраненияФайлов();
		КонецЕсли;
	Иначе
		НастройкаЗавершена = Ложь;
...
Процедура ЗавершитьИнициализациюУзла()
...
&НаКлиенте
Процедура ЗавершитьНастройкуЗакрытьФорму()
...
&НаКлиенте
Процедура ВыполнитьНастройкуТомовХраненияФайлов()
	
	Оповещение = Новый ОписаниеОповещения(
		"ВыполнитьНастройкуТомовХраненияФайловЗавершение", ЭтотОбъект);
	
	КОДКлиент.НачатьНастройкуТомовХраненияФайлов(Оповещение);
	
КонецПроцедуры

&НаКлиенте
Процедура ВыполнитьНастройкуТомовХраненияФайловЗавершение(Результат, ДополнительныеПараметры) Экспорт

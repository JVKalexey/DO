...
Функция ТипыОбрабатываемыеНаСервереВОдинПоток() Экспорт
	...
	ТипыВозврата.Добавить(Перечисления.ТипыЗаданий.ОбновитьHtmlПередОзнакомлениемСервер);
	ТипыВозврата.Добавить(Перечисления.ТипыЗаданий.ЗавершениеОзнакомленияСогласованияСервер);

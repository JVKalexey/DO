...
Процедура СохранитьТекущуюВерсиюРасширенияНаПК(Команда)
		...
		СохранитьТекущуюВерсиюРасширения();
...
&НаКлиенте
Асинх Процедура СохранитьТекущуюВерсиюРасширения()
...
Процедура НачатьВосстановлениеОригинальнойВерсииРасширения()
	...
	НачатьВосстановлениеОригинальнойВерсииРасширенияНаСервере();
	Закрыть(Истина);
	
КонецПроцедуры

&НаСервере
Процедура НачатьВосстановлениеОригинальнойВерсииРасширенияНаСервере()

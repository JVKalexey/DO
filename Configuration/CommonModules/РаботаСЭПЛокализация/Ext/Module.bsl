...
Процедура ДополнитьПараметрыФормированияНабораВажныхПолей(ПараметрыФормирования, ДополнительныеПараметры) Экспорт
	...
	Если ТипЗнч(ДополнительныеПараметры) = Тип("Структура")
		И ДополнительныеПараметры.Свойство("ЗаполнятьФормализованныйЭДО")
...
Функция ЗаполнитьДанныеФормализованногоДокумента(ОписаниеФайла, ПараметрыФормирования) Экспорт

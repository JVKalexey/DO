...
// Выполняет обработку результата процедуры начала настройки томов хранения файлов.
//
// Параметры:
//	Результат - Структура:
...
//
Процедура НачатьНастройкуТомовХраненияФайловОбработатьРезультат(Результат, Контекст) Экспорт
	
	Если ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(Результат, "Значение") = КодВозвратаДиалога.Да Тогда
		Оповещение = Новый ОписаниеОповещения(
			"ЗавершитьНастройкуТомовХраненияФайлов", ЭтотОбъект, Контекст);
		
		ОткрытьФорму(
			"Справочник.ТомаХраненияФайлов.ФормаСписка",,
			ЭтотОбъект,,,,
			Оповещение,
...
// Выполняет обработку результата завершения настройки томов хранения файлов.
//
// Параметры:
//	Результат - Произвольный - Результат действия.
//	Контекст - Структура:
//		* ОбработчикЗавершения - ОписаниеОповещения.
//
Процедура ЗавершитьНастройкуТомовХраненияФайлов(Результат, Контекст) Экспорт
...
// Параметры:
//	Контекст - Структура:
//		* Оповещение - ОписаниеОповещения, Неопределено - Оповещение, которое должно быть выполнено.

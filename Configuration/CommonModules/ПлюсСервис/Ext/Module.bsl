...
Процедура СинхронизацияРекомендаций() Экспорт
	...
	Если Не РазрешеныСборИОтправкаСведений() Или Не Используется() Тогда
		Возврат;
	КонецЕсли;
...
Процедура УстановитьРасширение(ЗаданиеНаУстановку, УстановкаИзВременныхФайлов = Ложь, ДанныеРасширения = Неопределено) Экспорт
...
Процедура УдалитьРасширениеИзКорзины(ЗаданиеНаУстановку, ИдСеанса) Экспорт
...
Процедура ОповеститьМенеджерСервисаОбУдалении(ДанныеРасширения)

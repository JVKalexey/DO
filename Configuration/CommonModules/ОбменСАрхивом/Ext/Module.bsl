...
Процедура ЗагрузитьОтчет(ФайлОписанияОтчета, КаталогИзвлеченныхФайлов)
	...
	Если ОбъектОтчетаXDTO.Тип().Имя = "HandOverList" Тогда
		ЗагрузитьОтчетПоСдаточнойОписи(ОтчетXDTO, ОбъектОтчетаXDTO, КаталогИзвлеченныхФайлов);
	Иначе
...
Процедура ЗагрузитьОтчетПоСдаточнойОписи(ОтчетXDTO, ОбъектОтчетаXDTO, КаталогИзвлеченныхФайлов)

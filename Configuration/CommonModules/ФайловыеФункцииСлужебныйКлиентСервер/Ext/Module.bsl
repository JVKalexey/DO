...
// ХОЛД Начало
	Если ОбщегоНазначенияДокументооборотКлиентСервер.ЭтоДокументооборотХолдинга() Тогда
		
		ТекстОшибки = ФайловыеФункцииХолдингСлужебныйКлиентСервер.ОшибкаФайлНеНайденВХранилищеФайлов(
			ИмяФайла, ПоискВТоме, ВладелецФайла);
		Возврат ТекстОшибки;

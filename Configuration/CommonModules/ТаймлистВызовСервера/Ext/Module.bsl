...
// 
Функция РазрешеноДобавлятьФайлыТаймлистПревышающихМаксимальноДопустимыйОбъем(Знач Расширение, Знач Размер) Экспорт
...
Функция АвтопротоколДокументWord(Автопротокол) Экспорт
	...
	АвтопротоколДляСозданияФайла = ТаймлистВызовСервераЛокализация.ФорматированнаяСтрокаИзHTML(

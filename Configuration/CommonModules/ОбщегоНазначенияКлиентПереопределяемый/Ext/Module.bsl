...
Процедура ПередПериодическойОтправкойДанныхКлиентаНаСервер(Параметры) Экспорт
	...
	// Локализация
	// ПлюсСервис
	ИнтеграцияПодсистемПлюсКлиент.ПередПериодическойОтправкойДанныхКлиентаНаСервер(Параметры);
	// Конец ПлюсСервис
	// Конец Локализация
...
Процедура ПослеПериодическогоПолученияДанныхКлиентаНаСервере(Результаты) Экспорт
	...
	// Локализация
	// ПлюсСервис
	ИнтеграцияПодсистемПлюсКлиент.ПослеПериодическогоПолученияДанныхКлиентаНаСервере(Результаты);
	// Конец ПлюсСервис
	// Конец Локализация

...
Процедура ОбновитьОтметкуЭП(Документ, ЭП) Экспорт
	...
	ОписаниеЭП.Вставить("ДатаПодписания", ТекущаяДатаСеанса());
...
Функция ДвоичныеДанныеФайлаДляПодписанияДокумента(ФайлСсылка, ПараметрыФормирования)
	...
	// Локализация
	Если ПараметрыФормирования.ЗаполнятьФормализованныеФайлыЭДО Тогда
		...
		ОписаниеФайла = РаботаСЭПЛокализация.НовоеОписаниеФайла();
		...
		РезультатЗаполнения = РаботаСЭПЛокализация.ЗаполнитьДанныеФормализованногоДокумента(ОписаниеФайла, ПараметрыФормирования);

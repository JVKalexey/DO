...
Функция ЕстьУзлыНеИмеющиеДоступаКТомамЭтогоУзла() Экспорт
	...
	Возврат ПолучитьФункциональнуюОпцию("ИспользоватьКОД")
		И КОДПовтИсп.УзелИспользуетСобственноеФайловоеХранилище()
		И КОДПовтИсп.АдресатыБезДоступаКТомамЭтогоУзла().Количество() > 0;

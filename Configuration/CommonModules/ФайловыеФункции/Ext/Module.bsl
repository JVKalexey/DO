...
// ХОЛД Начало
	Если ПолучитьФункциональнуюОпцию("ИспользоватьКОД")
		И Не ОбменДаннымиДокументооборотПовтИсп.ЭтоЦентральныйУзел() Тогда
...
// Локализация
	...
	ПараметрыРаспознаванияДокументов = РаспознаваниеДокументов.ПараметрыРаспознаванияДокументов();
	
	Если РаспознаваниеДокументов.ВозможенЗапускРаспознаванияДокументов(ПараметрыРаспознаванияДокументов) Тогда
		...
		РаспознаваниеДокументов.ВыполнитьОбменССервисомРаспознаванияДокументов();

...
Функция ЗапросПравОднотипныхОбъектовПодлежитЛокализации(ПервыйОбъектДоступа) Экспорт
...
Процедура ЗаполнитьЗапросПравОднотипныхОбъектов(ПервыйОбъектДоступа, Запрос,МетаданныеОбъекта) Экспорт

...
Процедура ПрочитатьДействияВФормуПредмета(Форма, ПараметрыОбъектаОбработки, ПараметрыВидаОбъекта, НужнаИсторияОбработки = Ложь) Экспорт
	...
	ЕстьАктивноеИлиЗавершенноеДействиеСогласованияВРежимеЗамечаний = Ложь;
...
#КонецЕсли
		...
		ЕстьАктивноеИлиЗавершенноеДействиеСогласованияВРежимеЗамечаний =
			РезультатЗаполнения.ЕстьАктивноеИлиЗавершенноеДействиеСогласованияВРежимеЗамечаний;
	...
	ПараметрыДляКоманд.Вставить("ЕстьАктивноеИлиЗавершенноеДействиеСогласованияВРежимеЗамечаний", 
		ЕстьАктивноеИлиЗавершенноеДействиеСогласованияВРежимеЗамечаний);
					...
					Если ЗначениеЗаполнено(Стр.Участник) Тогда
						...
						Если ДанныеПодписанта <> Неопределено Тогда
							Если ДанныеПодписанта.Результат = Перечисления.РезультатыПодписания.Подписано Тогда
								...
								ДанныеПодписи.Вставить("ДатаПодписания", ТекущаяДатаСеанса());
...
// * ЕстьАктивноеИлиЗавершенноеДействиеСогласованияВРежимеЗамечаний - Булево. 
...
Функция ЗаполнитьДеревоОбработки(ПараметрыЗаполнения) Экспорт
	...
	РезультатЗаполнения.Вставить("ЕстьАктивноеИлиЗавершенноеДействиеСогласованияВРежимеЗамечаний", Ложь);

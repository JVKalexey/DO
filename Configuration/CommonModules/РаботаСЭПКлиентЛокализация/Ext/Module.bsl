...
// Локализация
	...
	Если ДелопроизводствоКлиентСервер.ЭтоФайл(Контекст.ПодписываемыеДанные) Тогда
		...
		Если Контекст.Свойство("ПараметрыДанных") И Контекст.ПараметрыДанных.Свойство("ЗаполнятьФормализованныйЭДО")
			И Контекст.ПараметрыДанных.ЗаполнятьФормализованныйЭДО = Истина Тогда
			...
			РезультатЗаполнения = ОбменСКонтрагентамиДОВызовСервера.ЗаполнитьДокументЭДОПриПодписании(
				...
				Контекст.ПараметрыДанных.ДанныеЗаполненияФормализованногоЭДО,
				Сертификат,
				Доверенность);
	...
	Иначе
		...
		Если Контекст.Свойство("ПараметрыДанных") И Контекст.ПараметрыДанных.Свойство("ЗаполнятьФормализованныйЭДО")
			...
			ДанныеЗаполненияФормализованногоЭДО = Контекст.ПараметрыДанных.ДанныеЗаполненияФормализованногоЭДО;
